...
export const process = {
  ...
  steps: [
    { n: "01", title: "Request intake and acknowledgment", text: "Target acknowledgment within 2–4 hours." , img: "/images/desk.jpg", alt: "Working at a desk in the office" },
    { n: "02", title: "Requirements validation", text: "Confirm job duties, qualifications, schedule, location, duration, credentials, and screening requirements." , img: "/images/documents.jpg", alt: "Reviewing candidate documents" },
    { n: "03", title: "Candidate sourcing", text: "Search the internal database and pipeline, employee referrals, job boards, local recruiting channels, and targeted outreach." , img: "/images/colleagues.jpg", alt: "Colleagues reviewing work together" },
    { n: "04", title: "Recruiter screening", text: "Verify hard skills, experience, availability, communication skills, and fit for the assignment." , img: "/images/interview.jpg", alt: "Interview at a client office" },
    { n: "05", title: "Candidate presentation", text: "Target submission of qualified candidates within 6–8 hours for many classifications; labor and administrative candidates may be available for immediate start depending on the requirement." , img: "/images/team.jpg", alt: "Savera Works team at work" },
    { n: "06", title: "Client interview and selection", text: "Coordinate telephone, virtual, or in-person interviews as requested." , img: "/images/hero-resume.jpg", alt: "Candidates around a laptop" },
    { n: "07", title: "Pre-employment vetting", text: "Complete required background, drug, driving-record, credential, education, employment, and other position-specific checks." , img: "/images/hero-about.jpg", alt: "Meeting in a client boardroom" },
    { n: "08", title: "Onboarding and deployment", text: "Complete employment documentation, payroll setup, assignment orientation, and reporting instructions." , img: "/images/agreement.jpg", alt: "Agreement across a desk" },
    { n: "09", title: "Ongoing management", text: "Confirm first-day start, maintain communication with the employee and hiring manager, and address performance or attendance issues promptly." , img: "/images/hero-services.jpg", alt: "Colleagues in an open-plan office" },
    { n: "10", title: "Replacement and continuity", text: "Rapidly source acceptable replacement personnel when an assignment ends unexpectedly or the City requests a change." , img: "/images/lounge.jpg", alt: "Team meeting in an office lounge" },
  ],
